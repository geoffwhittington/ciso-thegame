...
export const PERSONAS: Record<AvatarId, Persona> = {
  ...
  compliance: {
    ...
    lines: {
      ...
      alert_overload: [
        "The alert queue has exceeded our documented capacity. I have documented the exceeded capacity.",
        "Too many alerts, too few people. The auditor calls that a finding. Dev calls it Tuesday.",
        "We cannot investigate this volume responsibly. I've prepared the staffing justification Marcus will ignore.",
        "Our monitoring controls are generating evidence faster than humans can review it. An impressive failure.",
        "Alert overload is now on the risk register. It has its own tab. And appendix.",
        "Dev needs help. Marcus suggested turning off alerts. I have documented that suggestion very carefully.",
      ],
      trust_critical: [
  ...
  ciso: {
    ...
    lines: {
      greeting: [
        ...
        "New badge, new laptop, same suspiciously empty risk register.",
        "The board says security is a priority. The budget says security is a hobby.",
        "First day. Marcus said 'military-grade encryption' twice. Neither time correctly.",
        "I have inherited twelve tools, three spreadsheets, and one deeply concerned auditor.",
      ],
      quarter_calm: [
        ...
        "Nothing caught fire. Either we're improving or the logs stopped working.",
        "A quiet quarter. Marcus is already eyeing the leftover budget.",
        "No incidents. Dev remains suspicious. Honestly, so do I.",
        "Everything held. I will celebrate by checking the backups again.",
      ],
      quarter_breach: [
        ...
        "The incident plan says remain calm. The incident Slack channel has chosen another path.",
        "Marcus wants answers. Victoria wants a timeline. Dev wants to say 'I told you so.'",
        "Apparently 'accepting the risk' did not make the risk feel accepted.",
        "Time to discover which backups were 'definitely tested recently.'",
      ],
      budget_tight: [
        ...
        "The threat actors have more funding than I do. Love that for us.",
        "I can afford prevention or detection. Apparently choosing both is considered extravagant.",
        "The budget has entered its minimalist era.",
        "Another quarter of enterprise expectations and startup coupons.",
      ],
      trust_critical: [
        ...
        "Victoria used the phrase 'succession planning.' I am the succession being planned.",
        "My calendar invitation says 'Quick chat.' There is nothing quick about this chat.",
        "The board wants accountability. Marcus has helpfully pointed toward my chair.",
        "I should probably remove 'open to work' from private mode.",
      ],
      gameover_win: [
        ...
        "Still employed, mostly rested, and only slightly haunted by alert sounds.",
        "The company survived. The board is pleased. I will accept this temporary alignment of planets.",
        "IPO achieved. Marcus will call it leadership. Dev and I know it was patching.",
        "I kept the chair. More importantly, I kept the incident count out of double digits.",
      ],
      gameover_lose: [
        ...
        "My badge has been disabled. Efficient response time, finally.",
        "The board wanted a single throat to choke. Apparently mine had excellent availability.",
        "I leave behind a mature incident program and an immature executive team.",
        "On the bright side, I no longer own the audit findings.",
      ],
      trope: [
        ...
        "Someone asked whether ransomware is covered by the printer warranty.",
        "Sales marked the security questionnaire 'all yes' to save time.",
        "The password vault master password is in a sealed envelope. The envelope is missing.",
        "I have been invited to a meeting titled 'Security without slowing down.' This should be relaxing.",
      ],
    },
  },
};
